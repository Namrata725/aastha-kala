        ...
        <div className="max-w-7xl mx-auto space-y-6">
            <div className="flex flex-col lg:flex-row justify-between items-center p-4 lg:p-6 bg-white border border-gray-200 rounded-2xl gap-6 shadow-sm">
                <div className="flex flex-col text-center lg:text-left">
                    <span className="text-xl lg:text-2xl font-bold text-black">Booking Requests</span>
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4 w-full lg:w-auto">
                  ...
                  <select 
                    ...
                    className="w-full sm:w-auto px-4 py-2.5 text-sm bg-white border border-gray-200 rounded-xl focus:outline-none focus:border-primary transition shadow-sm min-w-[120px] cursor-pointer"
                  >
